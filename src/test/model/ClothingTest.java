...
public class ClothingTest {
    ...
    @BeforeEach
    void runBefore() {
        testClothing1 = new Clothing("Red", 5.50, "UBC", "Wool", "S", "Hoodie");
        testClothing2 = new Clothing("Blue", 10.00, "H&M", "Cotton", "M", "Sweater");
    }

    @Test
    void testConstructor() {
        assertEquals("Red", testClothing1.getColour());
        assertEquals(5.50, testClothing1.getPrice());
        assertEquals("UBC", testClothing1.getBrand());
        assertEquals("Wool", testClothing1.getMaterial());
        assertEquals("S", testClothing1.getSize());
        assertEquals("Hoodie", testClothing1.getDescription());

        assertEquals("Blue", testClothing2.getColour());
        assertEquals(10.00, testClothing2.getPrice());
        assertEquals("H&M", testClothing2.getBrand());
        assertEquals("Cotton", testClothing2.getMaterial());
        assertEquals("M", testClothing2.getSize());
        assertEquals("Sweater", testClothing2.getDescription());
    }

    static class WardrobeTest {
